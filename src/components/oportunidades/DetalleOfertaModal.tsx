...
export function DetalleOfertaModal({ oferta, onClose, onUpdateOferta }: DetalleOfertaModalProps) {
          ...
          <div className="flex-1 overflow-y-auto p-6">
            ...
            <div className="mb-6">
              ...
              <div className={cn(
                ...
                {oferta.descripcionOferta || "Sin descripción disponible para esta oferta."}
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-4 pt-4 border-t" style={{ borderColor: isHey ? 'rgba(255,255,255,0.1)' : '#e5e7eb' }}>
              <div>
                ...
                <span className={cn("text-sm font-medium", isHey ? "text-gray-300" : "text-gray-700")}>{oferta.promotorNombre}</span>
              </div>
              <div>
                <span className={cn("text-xs block mb-0.5", isHey ? "text-gray-500" : "text-gray-400")}>Campaña</span>
                <span className={cn("text-sm font-medium", isHey ? "text-gray-300" : "text-gray-700")}>{oferta.campaña}</span>
              </div>
              <div>
                <span className={cn("text-xs block mb-0.5", isHey ? "text-gray-500" : "text-gray-400")}>ID Cliente</span>
                <span className={cn("text-sm font-mono", isHey ? "text-gray-300" : "text-gray-700")}>{oferta.ide}</span>
              </div>
              <div>
                <span className={cn("text-xs block mb-0.5", isHey ? "text-gray-500" : "text-gray-400")}>Fecha Alta</span>
                <span className={cn("text-sm font-medium", isHey ? "text-gray-300" : "text-gray-700")}>{oferta.fechaAlta}</span>
              </div>
            </div>
          </div>
        </div>
